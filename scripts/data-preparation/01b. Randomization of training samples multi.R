...
train.crestedsignal <- 'data/AcousticData/Jahoo_trainingdata_manual_annotations_addDanum/CrestedGibbons'
...
# Specify the training folders
train.greysignal <- 'data/AcousticData/Jahoo_trainingdata_manual_annotations_addDanum/GreyGibbons/'
list.train.greywavs <- list.files(train.greysignal,full.names = T)
grey.class <- 'GreyGibbon'
length(list.train.greywavs)

train.noise <- 'data/AcousticData/Jahoo_trainingdata_manual_annotations_addDanum/Noise'
list.noise.wavs <- list.files(train.noise,full.names = T)
noise.class <- 'noise'
length(list.noise.wavs)

output.dir.random <- 'randomization/JahooGibbonClipsRandomMulti/'
