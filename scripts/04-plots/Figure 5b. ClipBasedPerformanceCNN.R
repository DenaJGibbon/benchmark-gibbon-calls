...
ModelFolders <- list.files('/Volumes/DJC Files/RSOS Benchmarking Data/JahooGibbonModelsRandomGibbonNetR',
           full.names = TRUE)
...
ModelFolders <- list.files('/Volumes/DJC Files/RSOS Benchmarking Data/JahooGibbonModelsRandomGibbonNetRmulti',
                           full.names = TRUE)
